...
def main1(enemy, algorithm):
    # Setting up the game
    enemy = 167
    experiment_name = 'adrian-testing-4'+"-algorithm-"+ str(algorithm)
...
#---------------- Setting the game enviroment ----------------
    ...
    def main(game, enemy):
        ...
        while max(fitnessValues) < 100 and generationCounter < max_generations:
            ...
            plt.savefig("adrian-testing-4" + "-algorithm-" + str(algorithm) +"-enemy-"+ str(enemy)+".png")
            plt.show()
            # DataFrame
...
algorithms = [16,17,18,19,20]
enemies = [1,6,7]
for algorithm in algorithms:
    for game in [1]:
        main1(game, algorithm)
