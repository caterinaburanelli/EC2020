...
def main1(seed, game, algorithm, group):
    ...
    toolbox.register("mutate", tools.mutPolynomialBounded,
                     eta=20.0, low=-1, up=1, indpb=0.05)
    ...
    def main(seed, game, group):
        ...
        while max(fits) < 100 and g < g_end:
            ...
            np.savetxt(experiment_name+'/Algorithm_' + algorithm_number + '_group_'+group+'/individuals_game_' +
                       str(game)+'/game_'+str(game)+'_gen_'+str(g)+'_group_'+str(group)+'_Tournement.txt', best_ind)
