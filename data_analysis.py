...
def data_analysis(algorithm, group, gen):
    data_file = f"{algorithm}-{group}.txt"
...
for i in range(16):
    ...
    algorithm = "1"
    values_T = data_analysis(algorithm, group, str(i))
for i in range(16):
    algorithm = "2"
    values_A = data_analysis(algorithm, group, str(i))
...
def line_plot():
    ...
    plt.title(f"Results for group {group}",fontsize=20)
